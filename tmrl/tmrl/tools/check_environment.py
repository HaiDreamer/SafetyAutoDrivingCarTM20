...
r'''debug / visualization utility for the environment in Trackmania Reinforcement Learning.
 It inspect observations, rewards, and environment behavior before training'''
