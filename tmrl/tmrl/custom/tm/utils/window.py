...
r'''MRL's cross-platform TrackMania window controller + screenshot grabber: it finds the game window, 
sizes it to the expected observation resolution, and returns frames as NumPy arrays for the RL agent'''
