...
r'''defines neural network architectures for a Soft Actor-Critic (SAC) reinforcement learning agent trained to play Trackmania, 
using the TMRL framework. It provides several actor-critic model families, ranging from simple MLPs to CNNs and RNNs'''
# SUPPORTED ============================================================================================================
