# central configuration/constants module for TMRL, sets up paths, loads config.json, checks compatibility, and exposes many values that the rest of the code imports and uses
